...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AutorisationApi()
        api_instance.get_est_autorise  # this is an instance of the class Endpoint
        api_instance.get_est_autorise()  # this invokes api_instance.get_est_autorise.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_est_autorise.callable or self.callable in this class
