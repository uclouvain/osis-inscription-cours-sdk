...
class InscriptionAuxCoursApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.mini_formations_inscriptibles_endpoint = _Endpoint(
            settings={
                'response_type': ([MiniFormation],),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{sigle_formation}/mini_formations/inscriptibles/',
    ...
    def mini_formations_inscriptibles(
        ...
        **kwargs
        ...
        >>> thread = api.mini_formations_inscriptibles(sigle_formation, async_req=True)
        >>> result = thread.get()
