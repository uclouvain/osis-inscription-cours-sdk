...
class PaeValideJuryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.mon_pae_valide_jury_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{code_programme}/mon_pae_valide_jury/',
                'operation_id': 'mon_pae_valide_jury',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def mon_pae_valide_jury(
        self,
        code_programme,
        **kwargs
    ):
        """mon_pae_valide_jury  # noqa: E501

        My_pae_validated_jury  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mon_pae_valide_jury(code_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code_programme'] = \
            code_programme
        return self.mon_pae_valide_jury_endpoint.call_with_http_info(**kwargs)
