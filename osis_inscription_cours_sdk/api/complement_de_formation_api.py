...
class ComplementDeFormationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_complement_de_formation_endpoint = _Endpoint(
            settings={
                'response_type': (ComplementDeFormation,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{code_programme}/complement_de_formation',
                'operation_id': 'get_complement_de_formation',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_complement_de_formation(
        self,
        code_programme,
        **kwargs
    ):
        """get_complement_de_formation  # noqa: E501

        Récupère le complément de formation si il y en a un  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_complement_de_formation(code_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code_programme'] = \
            code_programme
        return self.get_complement_de_formation_endpoint.call_with_http_info(**kwargs)
