...
class PeriodeInscriptionEtudiantApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_periode_endpoint = _Endpoint(
            settings={
                'response_type': (PeriodeInscriptionEtudiant,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{code_programme}/periode_inscription_etudiant/',
                'operation_id': 'get_periode',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_periode(
        ...
        **kwargs
        ...
        """get_periode  # noqa: E501

        Return period when student can enroll to courses  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_periode(code_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code_programme'] = \
            code_programme
        return self.get_periode_endpoint.call_with_http_info(**kwargs)
