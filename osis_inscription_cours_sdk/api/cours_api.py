...
class CoursApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.prerequis_acquis_endpoint = _Endpoint(
            settings={
                'response_type': ([UniteEnseignementAvecPrerequis],),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{code_programme}/prerequis_acquis/',
                'operation_id': 'prerequis_acquis',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def prerequis_acquis(
        self,
        code_programme,
        **kwargs
    ):
        """prerequis_acquis  # noqa: E501

        Renvoie la liste des unité d'enseignement qui ont des prérequis en spécifiant si ces prérequis sont acquis ou non  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.prerequis_acquis(code_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code_programme'] = \
            code_programme
        return self.prerequis_acquis_endpoint.call_with_http_info(**kwargs)
