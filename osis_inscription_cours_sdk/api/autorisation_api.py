...
class AutorisationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_est_autorise_endpoint = _Endpoint(
            settings={
                'response_type': (AutoriseInscrireAuxCours,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{code_programme}/autorise/',
                'operation_id': 'get_est_autorise',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_est_autorise(
        self,
        code_programme,
        **kwargs
    ):
        """get_est_autorise  # noqa: E501

        Return if student can enroll to courses  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_est_autorise(code_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code_programme'] = \
            code_programme
        return self.get_est_autorise_endpoint.call_with_http_info(**kwargs)
