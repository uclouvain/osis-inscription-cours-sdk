...
------------- | ------------- | -------------
[**ma_proposition_de_pae**](PropositionProgrammeApi.md#ma_proposition_de_pae) | **GET** /{code_programme}/ma_proposition_de_pae/ | 
...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} ma_proposition_de_pae(code_programme)
...
with osis_inscription_cours_sdk.ApiClient(configuration) as api_client:
    ...
    code_programme = "LSINF100B" # str | The url of the pdf pae submission
    ...
    try:
        api_response = api_instance.ma_proposition_de_pae(code_programme)
        pprint(api_response)
    except osis_inscription_cours_sdk.ApiException as e:
        print("Exception when calling PropositionProgrammeApi->ma_proposition_de_pae: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.ma_proposition_de_pae(code_programme, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_inscription_cours_sdk.ApiException as e:
        print("Exception when calling PropositionProgrammeApi->ma_proposition_de_pae: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **code_programme** | **str**| The url of the pdf pae submission |
